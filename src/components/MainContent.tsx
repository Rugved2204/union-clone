    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center bg-white p-4 rounded shadow-sm">
        <div className="relative">
          <img 
            src="https://www.unionbankonline.co.in/images/dicgc-logo.png" 
            alt="DICGC Logo" 
            className="h-28"
          />
          <div className="absolute -left-4 top-1/2 transform -translate-y-1/2">
            <div className="bg-red-600 text-white rounded-full p-1">←</div>
          </div>
        </div>
        <div className="relative">
          <img 
            src="https://www.unionbankonline.co.in/images/qr-code.png" 
            alt="QR Code" 
            className="h-28"
          />
      ...
      <div className="bg-white rounded shadow-sm p-4">
        ...
        <p className="text-sm text-gray-700">
          You have registered for mandatory additional layer of security, i.e. Positive Confirmation and generation of OTP. Hence, in case of providing incorrect answers to the such challenge questions your Internet Banking will be Blocked. To such cases, please call our toll free number 1800-208-2244 and choose option no. 3 for further process.
        </p>
      </div>
